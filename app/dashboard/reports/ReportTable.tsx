...
export const ReportTable = () => {
  ...
  const filteredReports = reports.filter(
    (report) =>
      report.patient.fullName.toLowerCase().includes(searchQuery.toLowerCase()) ||
      report.patient.patientId.toLowerCase().includes(searchQuery.toLowerCase()) ||
      report.patient.company.name.toLowerCase().includes(searchQuery.toLowerCase())
  );
