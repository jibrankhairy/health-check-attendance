// app/dashboard/reports/view/[reportId]/page.tsx
"use client";
...
// Ganti import ke dokumen utama yang baru
    ...
    <div className="flex flex-col h-screen">
        <div className="p-4 bg-gray-100 border-b flex justify-between items-center">
            ...
            <PDFDownloadLink
                ...
                fileName={`Laporan_MCU_${reportData.patient.fullName.replace(/\s/g, '_')}.pdf`}
            >
        ...
        <div className="flex-grow">
            <PDFViewer width="100%" height="100%">
                {/* Gunakan komponen utama di sini */}
