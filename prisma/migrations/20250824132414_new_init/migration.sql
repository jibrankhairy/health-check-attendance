...
CREATE TABLE `McuResult` (
    ...
    `timbalDarah` TEXT NULL,
    `arsenikUrin` TEXT NULL,
    `urinWarna` TEXT NULL,
    ...
    `ekgAdvice` TEXT NULL,
    `treadmillImage1` TEXT NULL,
    `treadmillImage2` TEXT NULL,
    `treadmillImage3` TEXT NULL,
    `treadmillLamaLatihan` TEXT NULL,
    `treadmillKlasifikasiKebugaran` TEXT NULL,
    `treadmillKerjaFisik` TEXT NULL,
    `treadmillKelasFungsional` TEXT NULL,
    `treadmillHasilTest` TEXT NULL,
    `treadmillSaran` TEXT NULL,
    ...
    `audiometryKesimpulanTelingaKanan` TEXT NULL,
    `audiometryKesimpulanTelingaKiri` TEXT NULL,
    `audiometryKesimpulanUmum` TEXT NULL,
    `audiometrySaran` TEXT NULL,
    `spirometryFvc` DOUBLE NULL,
    `spirometryFvcPred` DOUBLE NULL,
    `spirometryFvcPost` DOUBLE NULL,
    `spirometryFev1` DOUBLE NULL,
    `spirometryFev1Pred` DOUBLE NULL,
    `spirometryFev1Post` DOUBLE NULL,
    `spirometryFev1Fvc` DOUBLE NULL,
    `spirometryFev1FvcPred` DOUBLE NULL,
    `spirometryFev6` DOUBLE NULL,
    `spirometryFev6Pred` DOUBLE NULL,
    `spirometryPef` DOUBLE NULL,
    `spirometryPefPred` DOUBLE NULL,
    `spirometryPefPost` DOUBLE NULL,
    `spirometryFef2575` DOUBLE NULL,
    `spirometryFef2575Pred` DOUBLE NULL,
    `spirometryFef25` DOUBLE NULL,
    `spirometryFef25Pred` DOUBLE NULL,
    `spirometryFef25Post` DOUBLE NULL,
    `spirometryFef50` DOUBLE NULL,
    `spirometryFef50Pred` DOUBLE NULL,
    `spirometryFef50Post` DOUBLE NULL,
    `spirometryFef75` DOUBLE NULL,
    `spirometryFef75Pred` DOUBLE NULL,
    `spirometryFef75Post` DOUBLE NULL,
    `spirometryPostBdNote` TEXT NULL,
    `spirometryQualityAccept` TEXT NULL,
    `spirometryQualityRepeat` TEXT NULL,
    `spirometryEffortCount` TEXT NULL,
    `spirometryImage` TEXT NULL,
    `kesimpulanSpirometry` TEXT NULL,
    ...
    `biomonitoringValidatorName` VARCHAR(191) NULL,
    `biomonitoringValidatorQr` TEXT NULL,
    `urinalisaValidatorName` VARCHAR(191) NULL,
    `urinalisaValidatorQr` TEXT NULL,
    `audiometryValidatorName` VARCHAR(191) NULL,
    `audiometryValidatorQr` TEXT NULL,
    `spirometryValidatorName` VARCHAR(191) NULL,
    `spirometryValidatorQr` TEXT NULL,
    ...
    `treadmillValidatorName` VARCHAR(191) NULL,
    `treadmillValidatorQr` TEXT NULL,
