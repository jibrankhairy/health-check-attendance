...
CREATE TABLE `McuResult` (
    ...
    `pemeriksaanLabStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanLabPetugas` VARCHAR(191) NULL,
    `pemeriksaanRadiologiStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanRadiologiPetugas` VARCHAR(191) NULL,
    `pemeriksaanSpirometryStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanSpirometryPetugas` VARCHAR(191) NULL,
    `pemeriksaanAudiometryStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanAudiometryPetugas` VARCHAR(191) NULL,
    `pemeriksaanEkgStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanEkgPetugas` VARCHAR(191) NULL,
    `pemeriksaanTreadmillStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanTreadmillPetugas` VARCHAR(191) NULL,
    `pemeriksaanUrinStatus` VARCHAR(191) NOT NULL DEFAULT 'PENDING',
    `pemeriksaanUrinPetugas` VARCHAR(191) NULL,
