...
type SpirometryData = {
  ...
  pef?: string | number | null;
  pefPred?: string | number | null;
  pefPost?: string | number | null;
  fef25?: string | number | null;
  fef25Pred?: string | number | null;
  fef25Post?: string | number | null;
  fef50?: string | number | null;
  fef50Pred?: string | number | null;
  fef50Post?: string | number | null;
  fef75?: string | number | null;
  fef75Pred?: string | number | null;
  fef75Post?: string | number | null;
};
...
export const FlowVolumeChart = ({ data }: FlowVolumeChartProps) => {
  const {
    fvc,
    fvcPred,
    fvcPost,
  ...
  const postData = React.useMemo(
    ...
    [fvcPost, pefPost, fef25Post, fef50Post, fef75Post]
  );
  const predData = React.useMemo(
    ...
    [fvcPred, pefPred, fef25Pred, fef50Pred, fef75Pred]
  );

  const yMax =
    Math.max(toNum(pef) || 0, toNum(pefPost) || 0, toNum(pefPred) || 0, 8) *
    1.2;
  const xMax = Math.max(
    toNum(fvc) || 0,
    toNum(fvcPost) || 0,
