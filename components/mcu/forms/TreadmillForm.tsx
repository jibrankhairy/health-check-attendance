// components/mcu/forms/TreadmillForm.tsx
"use client";
...
import { SignatureField } from "./SignatureField"; // Pastikan komponen ini ada
import { ImageUploadField } from "./ImageUploadField"; // Komponen baru untuk upload
      ...
      <CardContent className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <ImageUploadField
              name="treadmillImage1"
              label="Gambar 1"
            />
            <ImageUploadField
              name="treadmillImage2"
              label="Gambar 2"
            />
            <ImageUploadField
              name="treadmillImage3"
              label="Gambar 3"
            />
          </div>
        </div>
