    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-6">
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <Select onValueChange={field.onChange} value={field.value || ""} defaultValue={field.value || ""}>
                                    <FormControl>
                                        <SelectTrigger><SelectValue placeholder="Pilih kesimpulan kondisi pasien" /></SelectTrigger>
                                    </FormControl>
                                    <SelectContent>
                                        <SelectItem value="FIT TO WORK">Fit to Work</SelectItem>
                                        <SelectItem value="FIT WITH NOTE">Fit with Note</SelectItem>
                                        <SelectItem value="UNFIT TEMPORARY">Unfit Temporary</SelectItem>
                                        <SelectItem value="UNFIT PERMANENTLY">Unfit Permanently</SelectItem>
                                    </SelectContent>
                                </Select>
                            </FormItem>
                        )}
                ...
                <div className="space-y-2">
                    <Label htmlFor="saran">Saran Tambahan (Bisa Pilih Banyak atau Ketik Baru)</Label>
                    <FormField
                        control={control}
                        name="saran"
                        render={({ field }) => (
                            <FormItem>
                                <MultiSelectCombobox
                                    ...
                                    // [PERBAIKAN] Gunakan pengecekan Array.isArray untuk keamanan
        ...
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                <Command onKeyDown={handleKeyDown}>
                    ...
                    <CommandList>
                        <CommandEmpty>
                            {inputValue ? `Tekan Enter untuk menambah "${inputValue}"` : "Ketik untuk mencari atau membuat saran baru."}
                        </CommandEmpty>
                        <CommandGroup>
                            {options.map((option) => (
                                <CommandItem
