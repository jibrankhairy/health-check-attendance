  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div className="flex items-center justify-between rounded-md border border-input p-3 min-h-[40px] text-sm ring-offset-background placeholder:text-muted-foreground focus-within:outline-none focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
      ...
      <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
        <Command onKeyDown={handleKeyDown}>
          <CommandInput
            placeholder="Cari atau ketik saran baru..."
            value={inputValue}
          ...
          <CommandList>
            <CommandEmpty>
              {isLoading
                ? "Memuat..."
                : "Saran tidak ditemukan. Tekan Enter untuk menambah."}
            </CommandEmpty>
            <CommandGroup>
