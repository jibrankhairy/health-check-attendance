    ...
    <Card>
      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-8">
        ...
        <div className="space-y-2">
          ...
          <Input id="hemoglobin" {...register("hemoglobin")} placeholder="cth: 12.5" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="leukosit">Leukosit</Label>
          <Input id="leukosit" {...register("leukosit")} placeholder="cth: 6.390" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="trombosit">Trombosit</Label>
          <Input id="trombosit" {...register("trombosit")} placeholder="cth: 283.000" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="hematokrit">Hematokrit</Label>
          <Input id="hematokrit" {...register("hematokrit")} placeholder="cth: 38.4" />
        </div>
        {/* Row 2 */}
        <div className="space-y-2">
          <Label htmlFor="eritrosit">Eritrosit</Label>
          <Input id="eritrosit" {...register("eritrosit")} placeholder="cth: 4.44" />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Input id="hitungJenisEosinofil" {...register("hitungJenisEosinofil")} placeholder="cth: 4" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="hitungJenisBasofil">Basofil</Label>
          <Input id="hitungJenisBasofil" {...register("hitungJenisBasofil")} placeholder="cth: 0" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="hitungJenisNeutrofilStab">Neutrofil Stab</Label>
          <Input id="hitungJenisNeutrofilStab" {...register("hitungJenisNeutrofilStab")} placeholder="cth: 4" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="hitungJenisNeutrofilSegmen">Neutrofil Segmen</Label>
          <Input id="hitungJenisNeutrofilSegmen" {...register("hitungJenisNeutrofilSegmen")} placeholder="cth: 44" />
        </div>
        {/* Row 5 */}
        <div className="space-y-2">
          <Label htmlFor="hitungJenisLimfosit">Limfosit</Label>
          <Input id="hitungJenisLimfosit" {...register("hitungJenisLimfosit")} placeholder="cth: 39" />
        </div>
        <div className="space-y-2">
          <Label htmlFor="hitungJenisMonosit">Monosit</Label>
          <Input id="hitungJenisMonosit" {...register("hitungJenisMonosit")} placeholder="cth: 9" />
        </div>
