        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="urinKejernihan"
                {...register("urinKejernihan")}
                placeholder="cth: JERNIH"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="urinBau"
                {...register("urinBau")}
                placeholder="cth: TIDAK MENYENGAT"
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="urinLeukositEsterase"
                {...register("urinLeukositEsterase")}
                placeholder="cth: POSITIF 1 (+)"
              />
            </div>
            <div className="space-y-2">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="space-y-2">
              ...
              <Input
                id="urinSedimenEritrosit"
                {...register("urinSedimenEritrosit")}
                placeholder="cth: 1-2"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="urinSedimenLeukosit"
                {...register("urinSedimenLeukosit")}
                placeholder="cth: 6-8"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="urinSedimenEpitel"
                {...register("urinSedimenEpitel")}
                placeholder="cth: 4-6"
              />
            </div>
            <div className="space-y-2">
