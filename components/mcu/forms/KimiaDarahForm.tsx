  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-8">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="space-y-2">
              ...
              <Input id="gulaDarahPuasa" {...register("gulaDarahPuasa")} placeholder="cth: 95" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="gulaDarah2JamPP">Gula Darah 2 Jam PP</Label>
              <Input id="gulaDarah2JamPP" {...register("gulaDarah2JamPP")} placeholder="cth: 102" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="kolesterolTotal">Kolesterol Total</Label>
              <Input id="kolesterolTotal" {...register("kolesterolTotal")} placeholder="cth: 189" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="trigliserida" {...register("trigliserida")} placeholder="cth: 72" />
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="asamUrat" {...register("asamUrat")} placeholder="cth: 5.5" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="kreatinin" {...register("kreatinin")} placeholder="cth: 0.8" />
            </div>
          </div>
        </div>
        ...
        <div>
            <h3 className="font-semibold mb-4 border-b pb-2">Hepatitis & Liver Function Test</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="space-y-2">
                    <Label htmlFor="hbsag">Hepatitis Marker (HBsAg)</Label>
                    <Input id="hbsag" {...register("hbsag")} placeholder="cth: NEGATIF (-)" />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="bilirubinTotal">Bilirubin Total</Label>
                    <Input id="bilirubinTotal" {...register("bilirubinTotal")} placeholder="cth: 0.5" />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="bilirubinDirect">Bilirubin Direct</Label>
                    <Input id="bilirubinDirect" {...register("bilirubinDirect")} placeholder="cth: 0.15" />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="alkaliPhosphatase">Alkali Phosphatase</Label>
                    <Input id="alkaliPhosphatase" {...register("alkaliPhosphatase")} placeholder="cth: 143" />
                </div>
            </div>
        </div>
        <SignatureField
