          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="relative aspect-square w-full">
                ...
                />
                <Label
                  htmlFor={`usg-mammae-upload-${index}`}
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="usgMammaeLaporan">
                Laporan USG Mammae Dextra dan Sinistra
              </Label>
              <Textarea
                id="usgMammaeLaporan"
                rows={8}
                {...register("usgMammaeLaporan")}
                placeholder="Intensitas echo parenchym mammae dextra dan sinistra normal..."
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="usgMammaeKesimpulan">Kesimpulan</Label>
              <Textarea
                id="usgMammaeKesimpulan"
                {...register("usgMammaeKesimpulan")}
                placeholder="USG mammae dextra dan sinistra normal..."
              />
            </div>
          </div>
        </div>
