// components/mcu/documents/BiomonitoringDocument.tsx
"use client";
...
// ... (Bagian Types dan Data Map tetap sama) ...
      ...
      <View style={styles.body}>
        ...
        <View style={{ marginTop: 15 }}>
          ...
          <Text style={{ fontSize: 8, lineHeight: 1.4, textAlign: 'justify' }}>
            ...
            tertentu dalam tubuh. <Text style={styles.resultAbnormal}>Timbal (Pb)</Text> dalam darah
            mengindikasikan tingkat paparan terkini terhadap logam berat yang
            dapat memengaruhi sistem saraf dan organ lainnya. <Text style={styles.resultAbnormal}>Arsenik (As)</Text> dalam
            urin menunjukkan paparan terkini terhadap metaloid yang juga
            berpotensi toksik bagi tubuh.
          </Text>
        </View>
